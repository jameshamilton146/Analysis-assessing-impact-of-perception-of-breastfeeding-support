...
i <- 1
  ...
  temp_controlModel <- polr(control_formula, data = temp_dt)
...
full_formula <- as.formula(paste("breast_feeding_intensity ~ ", 
  ...
  temp_fullModel <- polr(full_formula, 
            data = temp_dt)
  
  # if(i == 1){
  # multi_col_model <- polr(as.formula(paste("breast_feeding_intensity ~ ", 
...
# 
#   fwrite(coef_list[[i]], paste0(names(coef_list)[i], ".csv"))
#   
#   drive_rm(paste0(names(coef_list)[i], ".csv"))
#   drive_upload(paste0(names(coef_list)[i], ".csv"))
#   
#   drive_share(paste0(names(coef_list)[i], ".csv"),
#               role = "reader",
#               type = "user",
